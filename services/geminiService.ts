...
export async function getAuraResponse(
  ...
  const prompt = `
    ...
    4.  **Navigation and Progress**: If the passenger asks about the trip progress, ETA, or current location, provide a clear and reassuring update. Your instructions to the driver should always be concise and actionable.
    5.  **Vision Assistance**: If the passenger asks to describe their surroundings (e.g., "what do you see?", "what's around us?", "describe the scenery"), do not invent a description. Your intent MUST be 'DESCRIBE_SURROUNDINGS'. Your \`response_text\` must be a short, reassuring confirmation like "Of course. Let me take a look around for you."
